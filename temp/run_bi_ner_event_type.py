...
from model import BertForTokenClassificationWithDiceLoss, BertForTokenClassificationWithTrigger,\
     BertForTokenBinaryClassification, BertForTokenBinaryClassificationWithTrigger, BertForTokenBinaryClassificationWithTriggerAndEventType
...
MODEL_CLASSES = {
    ...
    "bert": (BertConfig, BertForTokenBinaryClassificationWithTriggerAndEventType, BertTokenizer),
...
def train(args, train_dataset, model, tokenizer, labels, pad_token_label_id):
    ...
    for iteration_index in train_iterator:
        ...
        for step, batch in enumerate(epoch_iterator):
            ...
            inputs = {"input_ids": batch[0], "attention_mask": batch[1], "start_labels": batch[3], "end_labels": batch[4], "event_type":batch[5]}
...
def load_and_cache_examples(args, tokenizer, labels, pad_token_label_id, mode):
    ...
    all_event_type_id  = torch.tensor([f.event_type_id for f in features], dtype=torch.long)

    dataset = TensorDataset(all_input_ids, all_attention_mask, all_token_type_ids, all_start_label_ids, all_end_label_ids, all_event_type_id)
    return dataset
