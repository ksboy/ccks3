...
def load_and_cache_examples(args, tokenizer, labels, pad_token_label_id, mode):
    ...
    if os.path.exists(cached_features_file) and not args.overwrite_cache:
        ...
        examples = read_examples_from_file(args.data_dir, args.schema,  mode, args.task, args.dataset)
    ...
    all_start_label_ids = torch.tensor([f.start_label_ids for f in features], dtype=torch.int8)
    all_end_label_ids = torch.tensor([f.end_label_ids for f in features], dtype=torch.int8)
