...
DATA_DIR=./data/trigger_classify/0/
...
# CUDA_VISIBLE_DEVICES=2,3 python -m torch.distributed.launch --nproc_per_node=2 run_classify.py \
CUDA_VISIBLE_DEVICES=2,3 python3 run_classify.py \
--task $TASK \
--model_type bert \
