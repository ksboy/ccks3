...
from model import BertForSequenceMultiLabelClassification as AutoModelForTokenClassification
...
def load_and_cache_examples(args, tokenizer, labels, pad_token_label_id, mode):
    ...
    all_labels = torch.tensor([convert_label_ids_to_onehot(f.label, labels) for f in features], dtype=torch.int8)
