...
def evaluate(args, model, tokenizer, trigger_labels, role_labels, pad_token_label_id, mode, prefix=""):
    ...
    batch_trigger_out_label_list = get_entities(trigger_start_out_label_ids, trigger_end_out_label_ids, attention_mask)
    batch_role_out_label_list = get_entities(role_start_out_label_ids, role_end_out_label_ids, attention_mask)
    ...
    results = {
        "loss": eval_loss,
        "trigger_precision":  precision_score(batch_trigger_out_label_list, batch_trigger_preds_list),
        "trigger_recall": recall_score(batch_trigger_out_label_list, batch_trigger_preds_list),
        "trigger_f1":  f1_score(batch_trigger_out_label_list, batch_trigger_preds_list),
        "role_precision":  precision_score(batch_role_out_label_list, batch_role_preds_list),
        "role_recall": recall_score(batch_role_out_label_list, batch_role_preds_list),
        "role_f1":  f1_score(batch_role_out_label_list, batch_role_preds_list),
        "f1": (f1_score(batch_trigger_out_label_list, batch_trigger_preds_list) + \
            f1_score(batch_role_out_label_list, batch_role_preds_list))/2
    }
